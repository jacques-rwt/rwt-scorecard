...
// ── DEV: auto-jump to results with mock data ──
window.addEventListener('DOMContentLoaded', function(){
  userData = { biz: 'Acme Manufacturing Ltd', name: 'James Whitfield', email: 'james@acmemfg.com', phone: '' };
  // Spread scores across categories to produce a realistic mixed result (~68 overall)
  answers = [80,65,50,75,90,60,45,70,55,80,65,50,75,85,60,45,70,80,55,65];
  showResults();
});
